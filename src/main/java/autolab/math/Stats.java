...
public class Stats {
    ...
    public enum StretchMethod{
        ...
        public String toString(){
            switch(this){
                case MINMAX: return "Minimum-Maximum";
                case EQUALIZE: return "Histogram Equalize";
                case STDEV: return "Standard Deviations";
                case NONE: return "No Stretch";
                default: throw new IllegalArgumentException();
            }
        }
    }
    ...
    public enum FilterMethod {
        ...
        public String toString(){
            switch(this){
                case SLOPE: return "Slope Angle";
                case HILLSHADE: return "Hill Shading";
                case ASPECT: return "Aspect";
                case PLANCURV: return "Planar Curvature";
                case PROFCURV: return "Profile Curvature";
                case CURV: return "Curvature";
                ...
                case DISTAREAL: return "Areal Distortions";
                case DISTPHI: return "Parallel Distortions";
                case DISTLAMBDA: return "Meridian Distortions";
                case DISTANG: return "Angular Distortions";    
    ...
    public enum KernelShape {
        ...
        public String toString(){
            switch(this){
                case CIRCLE: return "Minimum";
                case SQUARE: return "Maximum";
                default: throw new IllegalArgumentException();
            }
        }
    }
